...
class TeachingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teaching" do
    assert_difference('Teaching.count') do
      post teachings_url, params: { teaching: { category_id: @teaching.category_id, link: @teaching.link, title: @teaching.title, views: @teaching.views } }
    end
  ...
  test "should update teaching" do
    patch teaching_url(@teaching), params: { teaching: { category_id: @teaching.category_id, link: @teaching.link, title: @teaching.title, views: @teaching.views } }
